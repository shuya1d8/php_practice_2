...
DROP DATABASE IF EXISTS logologo;

-- kouka2249580データベースの作成
CREATE DATABASE logologo DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

-- ユーザ（DBのユーザ）を作成
-- GRANT all ON logologo.* TO 'stuff'@'localhost' identified BY '';
